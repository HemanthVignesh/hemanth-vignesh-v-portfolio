      ...
      <div className="grid lg:grid-cols-[1fr_auto_1fr] gap-12 lg:gap-8 items-center max-w-7xl mx-auto">
        ...
        >
          <div className="space-y-6 max-w-sm w-full">
            ...
            <div className="flex flex-col gap-3 py-4 border-y border-border/20 w-full">
            ...
            <a
              href="#projects"
              className="group inline-flex items-center gap-3 text-primary text-xs font-bold uppercase tracking-widest hover:text-foreground transition-colors"
            >
        ...
        >
          ...
          >
            <span className="block drop-shadow-[0_0_15px_rgba(var(--primary-rgb),0.1)] overflow-hidden flex">
            ...
            <span className="block overflow-hidden flex">
              {name2.map((char, index) => (
                <motion.span 
                  ...
                  className="inline-block text-transparent bg-clip-text bg-gradient-to-b from-foreground to-foreground/40"
                >
                  {char === " " ? "\u00A0" : char}
                </motion.span>
              ))}
        ...
        >
          <div className="relative group perspective-1000 w-64 h-80 lg:w-72 lg:h-[400px]">
            {/* Ambient Glow */}
            <div className="absolute inset-0 bg-primary/20 blur-[60px] rounded-full mix-blend-multiply dark:mix-blend-screen opacity-50 group-hover:opacity-100 transition-opacity duration-700" />

            {/* Floating Border Animation */}
            <motion.div 
               animate={{ boxShadow: ["0 0 0px rgba(var(--primary-rgb), 0)", "0 0 20px rgba(var(--primary-rgb), 0.4)", "0 0 0px rgba(var(--primary-rgb), 0)"] }}
            ...
            <motion.div
              ...
              className="absolute inset-0 bg-card/60 border border-border/20 backdrop-blur-sm transition-transform duration-700 ease-out group-hover:-rotate-y-12 group-hover:rotate-x-12 z-10 overflow-visible"
            ...
            >
              ...
              <img
                ...
                className="absolute inset-0 w-full h-full object-cover opacity-0 group-hover:opacity-100 transition-all duration-700 scale-100 group-hover:scale-[1.25] group-hover:-translate-y-12 z-20 drop-shadow-[0_20px_40px_rgba(0,0,0,0.4)] dark:drop-shadow-[0_20px_40px_rgba(0,0,0,0.8)]"
              />
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="absolute -left-6 top-1/4 px-3 py-2 bg-background/80 backdrop-blur-md border border-border/20 rounded-lg text-[10px] font-mono uppercase text-foreground/80 z-40 shadow-lg shadow-foreground/5 cursor-pointer"
            >
              System Arch
            </motion.div>
            <motion.div
